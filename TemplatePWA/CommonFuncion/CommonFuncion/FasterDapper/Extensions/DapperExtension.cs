...
namespace CommonFuncion.FasterDapper.Extensions
{
	...
	{
		private static Dictionary<string, DbType> DbTypeToCSharpTypes = new()
		{
		...
		public static IDictionary<TValue, TKey> InverseDictionary<TKey, TValue>(this Dictionary<TKey, TValue> self)
		{
			if (self == null)
			{
		...
		public static DynamicParameters ParseDynamicParameters<T>(this T self)
		{
			...
			DynamicParameters dinamicParameters = new DynamicParameters();
